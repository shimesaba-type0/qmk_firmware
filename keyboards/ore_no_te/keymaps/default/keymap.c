 ...
 */
  ...
  [_BASE] = LAYOUT( \
    ...
    KC_LSFT, KC_Z, KC_X,    KC_C,              KC_V,           KC_B,           KC_LBRC, KC_RBRC, KC_N,           KC_M,              KC_COMM,           KC_DOT,          KC_SLSH, KC_RSFT, \
                   MO(_META),   LT(_SYMB, KC_ESC), LCTL_T(KC_SPC), SFT_T(KC_TAB),                    SFT_T(KC_BSPC), LT(_META, KC_ENT), LT(SYMB, KC_DEL), LT(KC_RCTL, KC_RALT) \
  ),
 ...
 */
 [_META] = LAYOUT( \
     _______, XXXXXXX, XXXXXXX, ARROW,    ECLYN,   BASE,                          KC_HOME, KC_END,  KC_LCAP, KC_PSCR,  EEP_RST, RESET, \
     _______, KC_1,    KC_2,    KC_3,     KC_4,    KC_5,                          KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    KC_PIPE, \
     _______, KC_F6,   XXXXXXX, KC_MHEN,  KC_HENK, XXXXXXX, KC_PLUS,     KC_MINS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_F7,   XXXXXXX, \
 ...
 */
 [_SYMB] = LAYOUT( \
     ...
     _______, XXXXXXX,  KC_APP,  KC_LGUI,   XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_DQT,  KC_QUOT, KC_SCLN, KC_MINS, KC_QUES,   KC_RSFT, \
                        _______, _______,   _______, _______,                   _______, _______, _______, _______ \
 ),
