 ...
 */
  ...
  [_BASE] = LAYOUT( \
    ...
    KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_GRV,      KC_EQL,  KC_H, KC_J, KC_K,    KC_L,   KC_SCLN, KC_MINS, \
    KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LBRC,     KC_RBRC, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RALT, \
    /* Left thumb keys */
...
/* META
 * ,-----------------------------------------.                 ,-----------------------------------------.
 * | Esc  |      |_BASE |ARROW |ECLYN | BASE |                 | HOME |  END |      |PrtSc |EEPRST|Reset |
 * |------+------+------+------+------+------.                 |------+------+------+------+------+------|
 * | Tab  |   1  |   2  |   3  |   4  |   5  |                 |   6  |   7  |   8  |   9  |   0  |  |   |
 * |------+------+------+------+------+------+------.   ,-------------+------+------+------+------+------|
 * | Ctrl |      |      |Muhen |Henk  |  +   |  +   |   |  _   | Left | Down | Up   |Right |   .  |  -   |
 * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
 * | GUI  |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |   |  F7  |  F8  |  F9  |  F10 | F11  | F12  | Alt  |
 * `------+------+------+------+------+------+------'   `------+------+------+------+------+------+------|
 *               | META/|ESC/  |Space/|Tab/  |                 |BS/   |Enter/| SYMB/|RCTL/ |
 *               |      |~SYMB |LCtrl |Shift |                 |Shift |~META |  DEL | RALT |
 *               `---------------------------'                 `---------------------------'
 */
 [_META] = LAYOUT( \
     _______, XXXXXXX, _BASE,   ARROW,    ECLYN,   BASE,                          KC_HOME, KC_END,  _______, KC_PSCR,  EEP_RST, RESET, \
     _______, KC_1,    KC_2,    KC_3,     KC_4,    KC_5,                          KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    KC_PIPE, \
     _______, XXXXXXX, XXXXXXX, KC_MHEN,  KC_HENK, KC_PLUS, KC_PLUS,     KC_UNDS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_DOT,  _______, \
 ...
 */
 [_SYMB] = LAYOUT( \
     ...
     _______, XXXXXXX,  KC_APP,  KC_LGUI,   XXXXXXX,   XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX, KC_QUOT, XXXXXXX, XXXXXXX, KC_QUES,   _______, \
                        _______, _______,   _______,   _______,                   _______, _______, _______, _______ \
 ),
